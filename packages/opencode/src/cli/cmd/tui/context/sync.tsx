            ...
            setStore(
              produce((draft) => {
                ...
                for (const message of visible) {
                  ...
                  const nextParts = merged.parts.get(message.id) ?? currentParts
                  const parts = nextParts.flatMap((part) => {
                ...
                for (const [messageID] of merged.parts) if (!visibleIDs.has(messageID)) delete draft.part[messageID]
